...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [NUMBERS] = LAYOUT_pretty(
    ...
    KC_TRNS,   KC_HASH,   KC_TRNS,      KC_TRNS,     KC_RPRN,     KC_GRAVE,                           KC_TRNS,  KC_4,    KC_5,     KC_6,     KC_PLUS,     KC_TRNS,
    KC_TRNS,   KC_PERC,   KC_CIRC,     KC_LBRACKET, KC_RBRACKET, KC_TILD,                            KC_AMPR,  KC_1,    KC_2,     KC_3,     KC_BSLASH,   KC_TRNS,
               KC_TRNS,     KC_TRNS,     KC_TRNS,    KC_TRNS,                                   KC_NO,    KC_DOT,  KC_EQUAL, KC_TRNS,
...
const uint16_t PROGMEM tenkey_combo[] = {KC_S, KC_D, COMBO_END};
const uint16_t PROGMEM paste_combo[] = {KC_X, KC_V, COMBO_END};

combo_t key_combos[COMBO_COUNT] = {
  [SD_TENKEY] = COMBO_ACTION(tenkey_combo),
