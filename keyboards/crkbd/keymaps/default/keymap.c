...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    CTL_T(KC_ESC),  KC_A,   KC_S,               KC_D,               KC_F,               KC_G,           TO(_MOUSE),    KC_RCTL,    KC_H,     KC_J,                        KC_K,                       KC_L,               LT(_MOUSE, KC_SCLN),  CTL_T(KC_QUOTE),
    ...
    KC_TRNS,    TT(_GAMING),        KC_TRNS,        TT(_WINDOWS),   KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,  KC_TRNS,  KC_TRNS,
