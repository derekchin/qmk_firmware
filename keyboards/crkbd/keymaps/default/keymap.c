...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_split_3x6_3_ex2(
        ...
        CTL_T(KC_ESC),  KC_A,   KC_S,               KC_D,               KC_F,               KC_G,           KC_LCTL,    KC_RCTL,    KC_H,     KC_J,                        KC_K,                       KC_L,               LT(_MOUSE, KC_SCLN),  CTL_T(KC_QUOTE),
        KC_LSFT,        KC_Z,   KC_X,               KC_C,               KC_V,               KC_B,                                   KC_N,     KC_M,                        KC_COMM,                    KC_DOT,             KC_SLSH,                KC_RSFT,
                                      ALT_T(KC_F19),      GUI_T(KC_SPACE),    MO(_LAUNCHERL),    LT(_LAUNCHERR,KC_BSPC),    LT(_LAUNCHERL, KC_SPACE),   ALT_T(KC_F20)
        ),
        ...
        KC_TRNS,    TT(_ARROWS),    KC_TRNS,        TT(_NUMBERS),   MO(_SYMBOLSL),  KC_TRNS,        KC_LCTL,    KC_RCTL,       KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,  KC_TRNS,  KC_TRNS,
        ...
        KC_TRNS,    KC_TRNS,   KC_TRNS,   KC_TRNS,    KC_TRNS,    KC_TRNS,      KC_LCTL,    KC_RCTL,    KC_TRNS,          MO(_SYMBOLSR),  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,
        KC_TRNS,    KC_TRNS,   KC_TRNS,   KC_TRNS,    KC_TRNS,    KC_TRNS,          KC_TRNS,          KC_TRNS,        KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,
                                  KC_TRNS,    KC_TRNS,    KC_TRNS,          OSM(MOD_RGUI),    OSM(MOD_RALT),  KC_TRNS
        ),

        [_NUMBERS] = LAYOUT_split_3x6_3_ex2(
        KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,   KC_LCTL,    KC_RCTL,       KC_EQUAL, KC_7,    KC_8,     KC_9,     KC_ASTR,     KC_TRNS,
        ...
        KC_TRNS,  KC_TRNS,   HYPR(KC_F1), KC_MS_UP,   HYPR(KC_F2),   KC_TRNS,   KC_LCTL,    KC_RCTL,        KC_TRNS,                 KC_TRNS,                    KC_TRNS,     KC_ACL0,   KC_TRNS,   KC_TRNS,
        ...
        KC_TRNS,  KC_TRNS,   KC_TRNS,   KC_TRNS,  KC_TRNS,    KC_TRNS,   KC_LCTL,    KC_RCTL,       KC_TRNS,              KC_PGDN,            KC_PGUP,        KC_TRNS,     KC_TRNS,  KC_TRNS,
        ...
        KC_TRNS,  KC_TRNS,  KC_TRNS,       KC_TRNS,       KC_TRNS,      KC_TRNS,  KC_LCTL,    KC_RCTL,        KC_TRNS,   KC_TRNS,      KC_TRNS,     KC_TRNS,  KC_F3,      KC_TRNS,
        ...
        KC_TILD,   KC_EXLM,    KC_AT,      KC_HASH,    KC_DLR,    KC_PERC,     KC_LCTL,    KC_RCTL,           KC_CIRC,    KC_AMPR,    KC_ASTR,  KC_LPRN,       KC_RPRN,      KC_UNDS,
