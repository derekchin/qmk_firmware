...
[_SYMBOLS] = {
  { KC_TRNS,      KC_EXLM, KC_AT,   KC_HASH,   KC_DLR,    KC_PERC, KC_CIRC,  KC_CIRC, KC_AMPR, KC_ASTR,   KC_LPRN, KC_RPRN, KC_MINS },
  { TO(_QWERTY),  KC_LABK, KC_LCBR, KC_LSHIFT, KC_TRNS,   KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS, KC_RSHIFT, KC_LCBR, KC_RCBR, KC_EQL },
