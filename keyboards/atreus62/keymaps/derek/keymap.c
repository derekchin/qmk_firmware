...
[_QWERTY] = { /* qwerty */
  { _PLOVER,              KC_NO,              KC_NO,          KC_NO,     KC_NO,               KC_NO,            KC_NO,                KC_NO,       KC_NO,      KC_NO,         KC_NO,     KC_NO,                   KC_NO},
  ...
  { KC_LSFT,              KC_Z,               KC_X,           KC_C,      KC_V,                KC_B,             LT(_ARROWS,KC_SPC),   KC_N,        KC_M,       KC_COMM,       KC_DOT,    KC_SLSH,                 KC_RSFT},
  { MO(_NUMBERS),         MO(_SYMBOLS),       KC_F18,         KC_F19,    LT(_WINDOWS,KC_F20), GUI_T(KC_SPC),    ALT_T(KC_BSPC),       LT(_SYMBOLS, KC_SPC),    HYPR(KC_EQL),  KC_F17,    KC_F16,                  MO(_SYMBOLS),            OSM(MOD_MEH) }
},
